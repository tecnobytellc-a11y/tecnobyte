...
export default function App() {
  ...
  return (
    <div className="bg-[#0a0a12] text-gray-100 min-h-screen font-sans flex flex-col">
      ...
      <footer className="bg-black/90 border-t border-gray-800 text-gray-400 py-12"><div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8"><div className="flex flex-col items-center text-center"><h4 className="text-white font-orbitron font-bold text-xl mb-4">TECNOBYTE</h4><p className="text-[15px]">Innovación y seguridad en cada transacción. Tu aliado digital de confianza.</p></div><div className="flex flex-col items-center text-center"><h4 className="text-white font-orbitron font-bold text-xl mb-4">Ayuda</h4><ul className="space-y-3 text-[15px] flex flex-col items-center"><li className="cursor-pointer hover:text-white transition-colors"><a href="https://www.tecnobyte.lat/resoluciones">Centro de Resoluciones</a></li><li className="cursor-pointer hover:text-white transition-colors pt-1"><a href="https://www.tecnobyte.lat/resoluciones" className="bg-red-600 text-white text-[11px] font-bold px-2 py-1 rounded uppercase tracking-wider inline-block">¡Haz clic aquí!</a></li></ul></div><div className="flex flex-col items-center text-center"><h4 className="text-white font-orbitron font-bold text-xl mb-4">Síguenos</h4><div className="flex gap-4 justify-center"><a href={socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors"><Facebook /></a><a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors"><Instagram /></a><a href={socialLinks.tiktok} target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors"><TikTokIcon /></a></div></div><div className="flex flex-col items-center text-center"><h4 className="text-white font-orbitron font-bold text-xl mb-4">Legal</h4><ul className="space-y-3 text-[15px] flex flex-col items-center"><li className="cursor-pointer hover:text-white transition-colors" onClick={() => setShowTerms(true)}>Términos y Condiciones</li><li className="cursor-pointer hover:text-white transition-colors" onClick={() => setShowPrivacy(true)}>Política de Privacidad</li></ul></div></div><div className="text-center mt-12 text-[13px] text-gray-600">© 2024 TecnoByte LLC. Todos los derechos reservados.</div></footer>
