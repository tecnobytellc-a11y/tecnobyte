...
// --- COMPONENTE REAL: PANTALLA DE VERIFICACIÓN QR CONECTADA A FIREBASE ---
...
export default function App() {
  ...
  if (isBlocked) return <BlockedScreen />;
    ...
    // 🚀 NUEVO: Si la URL es de un Código QR, mostramos la pantalla de verificación corporativa
...
const solicitarPinAutomatico = async (idProducto, valorTarjeta, precioPagado, correoCliente) => {
  try {
    ...
    if (datos.success) {
      ...
      // Ya no guardamos nada en setPinGenerado
    } else {
