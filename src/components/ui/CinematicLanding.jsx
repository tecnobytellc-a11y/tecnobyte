        ...
        <div className="w-full bg-white flex flex-col">
            ...
            <div className="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-20 text-center px-4 max-w-5xl mx-auto mt-16">
                    ...
                    <h1 className="text-5xl md:text-8xl font-black text-white mb-6 drop-shadow-2xl tracking-tighter font-orbitron leading-none">
                        DESBLOQUEA TU <span className="text-gradient">MUNDO</span>
                    </h1>
                    <p className="text-lg md:text-2xl text-slate-200 mb-10 max-w-3xl mx-auto font-light drop-shadow-md leading-relaxed">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div className="text-center p-6 rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-all group">
                            ...
                            <h3 className="text-xl font-bold text-slate-800 mb-3">Envios Automáticos</h3>
